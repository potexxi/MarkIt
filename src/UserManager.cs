    ...
    public class UserManager
    {
        ...
        public async Task<ErrorType> SignUpAndHandleErrors(string email, string password, Grid loadingScreen)
        {
            ...
            catch(Supabase.Gotrue.Exceptions.GotrueException ex)
            {
                ...
                if (ex.Reason is Supabase.Gotrue.Exceptions.FailureHint.Reason.UserBadEmailAddress)
                {
                ...
                if (ex.Reason is Supabase.Gotrue.Exceptions.FailureHint.Reason.UserAlreadyRegistered)
                {
